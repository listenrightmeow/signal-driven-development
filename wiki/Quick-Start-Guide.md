...
See [[Template: Domain Specification]] for the full template reference.
...
See [[Gap Categories]] for detailed guidance and [[Template: Gap Report]] for the full template.
...
See [[Template: Gap Resolution Log]] for the full template.
...
For a moderately complex domain (4--6 bounded contexts, 6--10 aggregates):
...
- Study the [[Worked Example: Veterinary Clinic]] for a complete three-pass walkthrough
- Read the [[Convergence Model]] for the visual process overview
